...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_1en5 = RealNumber('1e-5'); _sage_const_1en8 = RealNumber('1e-8'); _sage_const_10e3 = RealNumber('10e3')
def f(x,y):
